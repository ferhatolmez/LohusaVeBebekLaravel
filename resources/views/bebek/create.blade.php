...
@section('title', 'Bebek Izlem Formu')

@section('content')
<div class="container">
    <section class="d-flex flex-column flex-lg-row justify-content-between gap-3 align-items-lg-center mb-4">
        <div>
            <span class="badge-soft mb-2">Responsive form</span>
            <h1 class="h2 mb-1">Bebek Izlem Formu</h1>
            <p class="text-secondary mb-0">Zorunlu alanlar, numeric araliklar ve daha guclu veri kalitesi kurallari ile guncellendi.</p>
        </div>
    ...
    <form id="bebekForm" method="POST" action="{{ route('bebek.store') }}" novalidate>
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-sm-6 col-xl-3">
                        <label for="dogum_tarihi" class="form-label">Dogum tarihi</label>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <label for="kac_haftalik" class="form-label">Kac haftalik</label>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <label for="izlem_sayisi" class="form-label">Izlem sayisi</label>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <label for="kacinci_cocuk" class="form-label">Kacinci cocuk</label>
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-6 col-md-4 col-xl">
                        <label for="ates" class="form-label">Ates (C)</label>
                    ...
                    <div class="col-6 col-md-4 col-xl">
                        <label for="nabiz" class="form-label">Nabiz</label>
                    ...
                    <div class="col-6 col-md-4 col-xl">
                        <label for="bas_cevresi" class="form-label">Bas cevresi</label>
                    ...
                    <div class="col-6 col-md-4 col-xl">
                        <label for="gogus_cevresi" class="form-label">Gogus cevresi</label>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mt-4">
            <p class="text-secondary mb-0">Kayit sonrasi PDF alabilir, liste ekranindan kalite skorunu gorebilirsiniz.</p>
            <button type="submit" class="btn btn-primary btn-lg">Bebek kaydini olustur</button>
        </div>
    </form>
</div>
@endsection
