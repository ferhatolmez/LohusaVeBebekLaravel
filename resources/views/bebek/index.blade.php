    ...
    <section class="page-header">
        <div class="page-header-row">
            <div>
                ...
                <p class="text-secondary mb-0">Uzun filtre satırı toparlandı; aktif seçimler üstte görünür, tablo ise mobilde kart benzeri akışla okunabilir hale geldi.</p>
            </div>
        ...
        <div class="filter-panel">
            <div class="filter-toolbar">
                <div>
                    ...
                    <p class="text-secondary mb-0">İzlem seviyesi, termin ve muayene tarihi kombinasyonlarını aynı anda daraltabilirsiniz.</p>
                </div>
