...
<div class="form-section card shadow-sm mb-4">
    <div class="card-header">A1. Lohusanin tanitici bilgileri</div>
    <div class="card-body">
        <p class="text-secondary small mb-4">Kimlik ve temel sosyodemografik bilgiler bu adimda toplanir.</p>
        <div class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <label for="yas" class="form-label">Yas <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6">
                <label for="egitim_durumu" class="form-label">Egitim durumu <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="meslek" id="meslek" class="form-control form-control-lg only-letters @error('meslek') is-invalid @enderror" value="{{ old('meslek') }}" placeholder="Orn: Ebe" required>
                @error('meslek')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-6">
                <label for="saglik_guvence" class="form-label">Saglik guvencesi <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6">
                <label for="akraba_evliligi" class="form-label">Akraba evliligi</label>
            ...
            <div class="col-md-6">
                <label for="evlilik_yili" class="form-label">Evlilik yili</label>
            ...
            <div class="col-md-6">
                <label for="gebelik_planlandimi" class="form-label">Gebelik planlandi mi? <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6">
                <label for="dogum_yeri" class="form-label">Dogum yeri <span class="text-danger">*</span></label>
                <input type="text" name="dogum_yeri" id="dogum_yeri" class="form-control form-control-lg only-letters @error('dogum_yeri') is-invalid @enderror" value="{{ old('dogum_yeri') }}" placeholder="Orn: Istanbul" required>
