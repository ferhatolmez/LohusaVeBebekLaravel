...
<div class="form-section fade-in p-3 rounded card shadow-sm mb-4">
    ...
    <div class="card-body">
        ...
        <div class="mt-3"><label>Meme bakımı:</label><textarea name="meme_bakimi" class="form-control"></textarea></div>
        <div class="mt-3"><label>Sütyen kullanımı:</label><textarea name="sutyen_kullanimi" class="form-control"></textarea></div>
