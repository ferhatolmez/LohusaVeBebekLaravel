        ...
        <div class="page-header-row">
            ...
            <div class="d-flex flex-wrap gap-2">
                @can('export', App\Models\LohusaForm::class)
                    <a href="{{ route('lohusa.csv', request()->query()) }}" class="btn btn-outline-success d-flex align-items-center gap-2"><i data-lucide="file-spreadsheet" style="width:16px;height:16px"></i> Excel İndir</a>
                @endcan
